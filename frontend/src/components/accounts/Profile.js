...
import { avatarsName } from "../../constants";
...
export default function Profile() {
  ...
  const avatarURL = "https://api.dicebear.com/8.x/bottts/svg"
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const profile = {
        ...
        photoURL: avatarURL + "?seed=" + avatarsName[selectedAvatar],
      };
